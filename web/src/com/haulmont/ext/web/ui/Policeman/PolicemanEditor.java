...
package com.haulmont.ext.web.ui.Policeman;
 ...
 */
public class PolicemanEditor extends AbstractEditor {
    ...
    @Inject
    protected Datasource policemansDs;
    ...
    public void init(Map<String, Object> params) {
        ...
        policemansDs.addListener(new DsListenerAdapter() {
